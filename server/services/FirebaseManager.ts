...
class FCM {
    ...
    sendToUserSimple(adminID: string, title: string, body: string, link: string = null, props: string = null) {
    ...
    sendToUser(adminID: string, payload: NotificationPayloadType) {
    ...
    sendToDevice(registrationToken: string, payload: NotificationPayloadType) {
        return new Promise((resolve, reject) => {
            admin
                ...
                .catch(async (error) => {
                    ...
                    if (error.filter && error.filter((e: any) => JSON.stringify(e.error).indexOf("The provided registration token is not registered") >= 0)) {
    ...
    sendToTopic(topic: string, payload: NotificationPayloadType) {
        return new Promise((resolve, reject) => {
            admin
                .messaging()
    ...
    subscribeToTopic(registrationToken: string, topic: string) {
        return new Promise((resolve, reject) => {
            admin
                .messaging()
