...
router.get("/get/templates/for/:moduleId", async function (req: express.Request, res: express.Response) {
...
router.get("/get/surveys/for/:moduleId", async function (req: express.Request, res: express.Response) {
    const moduleId = req.params.moduleId;
...
router.get("/get/latest/survey/for/:moduleId", async function (req: express.Request, res: express.Response) {
    const moduleId = req.params.moduleId;
...
router.get("/get/survey/questions/for/:surveyId", async function (req: express.Request, res: express.Response) {
...
router.post("/submit/:surveyId", async function (req: express.Request, res: express.Response) {
    const surveyId = req.params.surveyId;
...
router.post("/create/survey/template/for/:moduleId", async function (req: express.Request, res: express.Response) {
    const moduleId = req.params.moduleId;
...
router.post("/activate/survey/for/:surveyTemplateId", async function (req: express.Request, res: express.Response) {
