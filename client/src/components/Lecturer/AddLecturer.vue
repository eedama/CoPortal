  ...
  <div>
    <div class="row">
      <div v-show="done" class="col s12 center-align card-panel">
        <md-empty-state
          md-icon="done"
          md-label="Lecturer was successfully added."
          md-description="You can now assign the lecturer to more modules / view the lecturer's progress."
        >
        </md-empty-state>
      </div>
            ...
            <div class="row" :key="m" v-for="(m, i) in lecturer.modules.length">
              <div class="col s10">
                <md-field>
                  ...
                  <md-select
                    v-model="lecturer.modules[i]"
                    :name="`modules-${i}`"
                    :id="`modules-${i}`"
                  >
                    <md-option
                      :disabled="
                        lecturer.modules.filter(lm => lm == _module._id)
                          .length > 0
                      "
              ...
              <div class="col s2 bottom-align">
                <a
                  v-on:click="lecturer.modules.push(null)"
                  v-if="
                    i == lecturer.modules.length - 1 &&
                      lecturer.modules[i] != null
                  "
                  class="btn btn-floating waves-effect"
                  ><i class="material-icons">add</i></a
                >
                <a
                  v-on:click="lecturer.modules.splice(i, 1)"
                  v-if="i != lecturer.modules.length - 1"
            ...
            <div class="row">
              ...
              <div class="input-field col m4 offset-m1 s12 text-center">
                <input
                  ...
                  type="password"
                />
                <label class="text-center" for="ConfirmPassword"
