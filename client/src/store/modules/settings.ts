...
const state: SettingStateType = {
  ...
  baseLink: "https://jmrsquared.com/api/coportal",
  originalLink: "https://jmrsquared.com/api/coportal",
  schoolAdded: false,
  school: null,
  defaultProfilePic:
...
const mutations: MutationTree<SettingStateType> = {
  changeSchool(state, school: string) {
    state.baseLink = state.originalLink + "/" + school;
    state.school = school;
    state.schoolAdded = true;
  }
};

const actions: ActionTree<SettingStateType, any> = {
  changeSchool: ({ commit }) => commit("changeSchool")
};
