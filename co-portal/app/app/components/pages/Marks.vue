  ...
  <page actionBarHidden="true">
    <ScrollView>
      <GridLayout rows="*,auto,auto" columns="*">
        <StackLayout row="1">
          <GridLayout rows="auto,auto" columns="*">
            <label row="0" verticalAlignment="center" textAlignment="center" class="mdi p-15 text-dark-black" fontSize="50%" :text="'mdi-checkbox-marked-circle-outline' | fonticon"></label>
            <label row="1" verticalAlignment="center" textAlignment="center" class="p-15 text-dark-black" fontSize="30%" text="Economics"></label>
          </GridLayout>
        </StackLayout>
             ...
             <CardView v-for="(marked,i) in marks" :key="i"   elevation="15" margin="5">                  
                  ...
                  :style="{backgroundColor:colorLoaded(marked.mark)}"
                   textAlignment="center"
                     :text="marked.attenpts+' '+ attempts"></label>
...
export default {
  ...
  mounted() {
    ...
    this.isLoading = true;
    this.$api
      . getQuizStudents("5c3d96f2df719f08332566c7")
      .then(currentMarks => {
