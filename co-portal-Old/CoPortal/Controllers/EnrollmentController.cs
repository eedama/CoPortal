...
namespace CoPortal.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CourseID,StudentID,FeesPaid")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CourseID,StudentID,FeesPaid")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
